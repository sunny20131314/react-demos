...
var FancyCheckbox = React.createClass({displayName: "FancyCheckbox",
  render: function() {
    ...
    return (
      React.createElement("label", React.__spread({},  this.props), 
...
ReactDOM.render(
  React.createElement(FancyCheckbox, {checked: true, title: "title", checker: "checker", id: "ha", onClick: console.log.bind(console)}, 
    "Hello world!"
  ),
