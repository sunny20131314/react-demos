...
//      console.log( this.props.title );
    return (
      <div className="component" htmlFor="component">
        ...
        '双向绑定: '
        <input type="text" valueLink={this.linkState('message')} />;{this.state.message}
        <br/>
        ...
        <textarea name="description" defaultValue="This is a \n . 花椒粉卡萨" />
        <br/>

        <input type="checkbox" checkedLink={this.linkState('booleanValue')} />; {'"'+ this.state.booleanValue + '"'}
        <br/>
